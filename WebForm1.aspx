<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="Restaurante_Web.WebForm1" %>
  ...
  <body class="bg-light">
    ...
    <div class="site-wrap">
      ...
      <nav class="site-menu" id="ftco-navbar-spy">
        <div class="site-menu-inner" id="ftco-navbar">
          <ul class="list-unstyled">
            ...
            <li><a href="#section-menu">Nuestro Menu</a></li>
            <li><a href="#section-Orden">Su Orden</a></li>
      ...
      <header class="site-header">
        ...
        <form id="frm_tabla" runat="server">
        <asp:ScriptManager ID="scm" runat="server"></asp:ScriptManager>
        <asp:UpdatePanel ID="udp" runat="server">
        <ContentTemplate>
      
      <div class="main-wrap " id="section-Inicio">
              ...
              <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-10" data-aos="fade-up">
                  <h2 class="heading mb-5">Welcome to Meal</h2>
                   <asp:Button ID="btnLogout" OnClick="btnLogout_Click" CssClass="smoothscroll btn btn-outline-white px-5 py-3" runat="server" Text="Logout" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="section pb-3 bg-white" id="section-CRUD-Usuarios" data-aos="fade-up">
          <div class="container">
            <div class="row align-items-center justify-content-center">
              <div class="col-md-12 col-lg-8 section-heading">
                <h2 class="heading mb-5">El Restaurant</h2>
              </div>
            </div>
          </div>
        </div> <!-- .section -->
        ...
        <div class="section bg-light" id="section-menu" data-aos="fade-up">
                    ...
                    <div class="d-block d-md-flex menu-food-item">
                      ...
                      <div class="price order-2">
                        <strong>$10.49</strong>
                         ...
                         <asp:TextBox ID="txtCantidad1" runat="server" ToolTip="Ingrese la Cantidad"></asp:TextBox>                        
                        <asp:Button ID="btnPlato1" OnClick="btnPlato1_Click" CssClass="smoothscroll btn btn-outline-dark px-5 py-3" runat="server" Text="Pedir Plato" />
                        <asp:HiddenField ID="hdfPlato1" runat="server" />
                      </div>
                    </div> <!-- .menu-food-item -->
                    ...
                    <div class="d-block d-md-flex menu-food-item">
                      ...
                      <div class="price order-2">
                        <strong>$11.99</strong>
                         ...
                         <asp:TextBox ID="txtCantidad2" runat="server" ToolTip="Ingrese la Cantidad"></asp:TextBox>                        
                        <asp:Button ID="btnPlato2" OnClick="btnPlato2_Click" CssClass="smoothscroll btn btn-outline-dark px-5 py-3" runat="server" Text="Pedir Plato" />
                          <asp:HiddenField ID="hdfPlato2" runat="server" />
                      </div>
                    </div> <!-- .menu-food-item -->
         ...
         <div class="section bg-light" id="section-Orden" data-aos="fade-up">
          <div class="container">
            <div class="row section-heading justify-content-center mb-5">
              <div class="col-md-8 text-center">
                <h2 class="heading mb-3">Menu</h2>
                ...
                <tr>
                    <td align="center">
                        <table width="80%">
                            <tr>
                                <td align="center" colspan="2">
                                    <h3><strong>Registro de las Ordenes</strong></h3>
                                </td>
                            </tr>
                            <tr>
                                <td style="height: 60px">
                                    <asp:Label ID="lblNombrePlato" runat="server" Text="Plato"></asp:Label>
                                </td>
                                <td style="height: 60px" colspan="2">
                                    <asp:TextBox ID="txtNombrePlato" runat="server" ReadOnly="true" ToolTip="Plato Escogido"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="height: 60px">
                                ...
                                <td style="height: 60px" colspan="2">
                                    <asp:TextBox ID="txtPrecioPlato" runat="server" ReadOnly="true" ToolTip="Precio del Plato"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="height: 60px">
                                    <asp:Label ID="lblCantidadNueva" runat="server" Text="Tipo"></asp:Label>
                                </td>
                                <td style="height: 60px" colspan="2">
                                    <asp:TextBox ID="txtCantidadNueva" runat="server" ToolTip="Ingrese la nueva cantidad"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" colspan="2">
                                    <asp:Button ID="btnGuardar" OnClick="btnGuardar_Click" CssClass="btn btn-success" runat="server" Text="Actualizar" />
                        ...
                        <asp:GridView ID="grvOrden" runat="server" OnRowCommand="grvOrden_RowCommand" CssClass="table table-responsive" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:BoundField DataField="IdOrden" HeaderText="#" />
                                <asp:BoundField DataField="CodOrden" HeaderText="Codigo" />
                                <asp:BoundField DataField="NombrePlato" HeaderText="Plato" />
                                <asp:BoundField DataField="PrecioPlato" HeaderText="Precio" />
                                <asp:BoundField DataField="TipoPlato" HeaderText="Categoria" />
                    ...
                    <td>
                        ...
                        <table width="30%" align="center">
                            ...
                            <tr>
                                ...
                                <td style="height: 60px" >
                                    <asp:TextBox ID="txtSubtotal" runat="server" ReadOnly="true" ToolTip="Calculo del Subtotal"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="height: 60px">
                                ...
                                <td style="height: 60px" colspan="2">
                                    <asp:TextBox ID="txtIVA" runat="server" ReadOnly="true" ToolTip="Calculo del IVA"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="height: 60px">
                                ...
                                <td style="height: 60px" colspan="2">
                                    <asp:TextBox ID="txtTotal" runat="server" ReadOnly="true" ToolTip="Calculo del Total"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" colspan="2">
                                    <asp:Button ID="btnFacturar" OnClick="btnFacturar_Click" CssClass="btn btn-success" runat="server" Text="Facturar" />                           
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td style="height: 50px">
                                    <asp:Label ID="lblMensajeFactura" ForeColor="Green" CssClass="label animated shake auto-style1" runat="server" Text=""></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td style="height: 50px">
                                    <asp:Label ID="lblMensajeErrorFactura" ForeColor="Red" CssClass="label animated shake auto-style1" runat="server" Text=""></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </td>
